...
os.system("CUDA_VISIBLE_DEVICES=2,3 python /home/dell/wz/AlphaPose/scripts/demo_inference_cjm.py" + \
        " --cfg " + CONFIG + \
        " --checkpoint " + CKPT + \
        " --video " + directory + \
        " --outdir " + output + \
        " --reidimg " + reidimg + \
        #" --pose_track " + \
        " --detector yolo --profile --save_video --gpus 0,1 --showbox --vis_fast --qsize 60")
end_time = time.time()
